...
import com.geeks.tictactoe.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String getPlayerOneGame = getIntent().getStringExtra("playerOne");
        String getPlayerTwoGame = getIntent().getStringExtra("playerTwo");

        binding.playerOneName.setText(getPlayerOneGame);
        binding.playerTwoName.setText(getPlayerTwoGame);
    ...
    private void performAction(ImageView imageView, int selectedBoxPosition) {
        ...
        if (playerTurn == 1) {
            imageView.setImageResource(R.drawable.ic_ximage);
            if (checkResults()) {
                ResultDialog resultDialog = new
            ...
            imageView.setImageResource(R.drawable.ic_oimage);
            if (checkResults()) {
